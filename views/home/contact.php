...
<div class="container">
	<div class="row">
		...
		<div class="col-9">
			<div class="lienhe">
			<div style="text-align:center"><p class="product_show_title">Liên hệ </p></div>
					...
					?>
								...
								<div class="contact_form">
									...
									<form action="index.php?controller=home&action=contact" method="POST">
										...
										<input type="text" id="number" name="number" placeholder="Số điện thoại" value="0<?=$_SESSION["user"]["sodienthoai"]?>" readonly="true">
									...
									<?php
										if(isset($_POST["ok"])){
											...
											$abc = contact::lienhesubmit($id,$content);
											if($abc == true){
												?>
													<br>
